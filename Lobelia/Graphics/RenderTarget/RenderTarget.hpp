...
namespace Lobelia::Graphics {
	...
	public:
		RenderTarget(const Math::Vector2& size, const DXGI_SAMPLE_DESC& sample = Config::GetRefPreference().msaa, const DXGI_FORMAT&  format = DXGI_FORMAT_R32G32B32A32_FLOAT);
